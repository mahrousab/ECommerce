...
namespace Api.Controllers
{
	...
	public class PaymentsController : BaseApiController
	{
		...
		public PaymentsController(IPaymentService payment, IUnitOfWork unit,
		...
		private readonly string _whSecret = "StripeSettings:WhSecret"!;
		...
		{
			var cart = await payment.CreateOrUpdatePaymentIntent(cartId);
